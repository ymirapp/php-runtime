...
/**
 * @covers \Ymir\Runtime\Lambda\Handler\RadicleLambdaEventHandler
 */
class RadicleLambdaEventHandlerTest extends TestCase
{
    ...
    public function testCanHandleWithApplicationAndWpConfigPresent()
    {
        ...
        $this->assertTrue((new RadicleLambdaEventHandler($this->getLoggerMock(), $process, $this->tempDir))->canHandle($this->getHttpRequestEventMock()));
    ...
    public function testCanHandleWithBedrockAutoloaderPresent()
    {
        ...
        $handler = new RadicleLambdaEventHandler($this->getLoggerMock(), $process, $this->tempDir);
    ...
    public function testCanHandleWithMissingApplicationConfig()
    {
        ...
        $this->assertFalse((new RadicleLambdaEventHandler($this->getLoggerMock(), $process, $this->tempDir))->canHandle($this->getHttpRequestEventMock()));
    ...
    public function testCanHandleWrongEventType()
    {
        ...
        $this->assertFalse((new RadicleLambdaEventHandler($this->getLoggerMock(), $process, ''))->canHandle($this->getInvocationEventInterfaceMock()));
    }
    ...
    public function testHandleCreatesFastCgiRequestToFolderIndexPhpIfFileExistsWithPayloadVersion1()
    {
        ...
        $this->assertInstanceOf(FastCgiHttpResponse::class, (new RadicleLambdaEventHandler($logger, $process, $this->tempDir))->handle($event));
    ...
    public function testHandleCreatesFastCgiRequestToPublicDirectoryWithContentPathsWithPayloadVersion1()
    {
        $event = $this->getHttpRequestEventMock();
        $logger = $this->getLoggerMock();
        $process = $this->getPhpFpmProcessMock();
    ...
    public function testHandleCreatesFastCgiRequestToPublicDirectoryWithContentPathsWithPayloadVersion2()
    {
        $event = $this->getHttpRequestEventMock();
        $logger = $this->getLoggerMock();
        $process = $this->getPhpFpmProcessMock();
    ...
    public function testHandleDoesntReturnStaticFileResponseForFileOutsideWebDirectoryWithPayloadVersion1()
    {
        ...
        $response = (new RadicleLambdaEventHandler($logger, $process, $this->tempDir))->handle($event);
    ...
    public function testHandleReturnsNotFoundHttpResponseForInaccessibleFiles(string $filePath)
    {
        ...
        $this->assertInstanceOf(NotFoundHttpResponse::class, (new RadicleLambdaEventHandler($this->getLoggerMock(), $process, $this->tempDir))->handle($event));
    ...
    public function testHandleReturnsStaticFileResponseForFileInsideWebDirectory()
    {
        ...
        $this->assertInstanceOf(StaticFileResponse::class, (new RadicleLambdaEventHandler($logger, $process, $this->tempDir))->handle($event));
